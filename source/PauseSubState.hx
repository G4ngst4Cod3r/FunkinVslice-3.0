...
class PauseSubState extends MusicBeatSubstate
{
	...
	var daComposer:String = ' - Kawai Sprite';
	...
	public function new(x:Float, y:Float)
	{
		...
		//levelInfo.text += PlayState.SONG.song + " - " + composerPauseText;
		if (PlayState.SONG.song.toLowerCase() == 'darnell') 
		{ 
			levelInfo.text += PlayState.SONG.song + daComposer + ' ft. IvanAlmighty';
		}
		else if (PlayState.SONG.song.toLowerCase() == 'lit-up') 
		{ 
			levelInfo.text += PlayState.SONG.song + daComposer + ' ft. IvanAlmighty';
		}
		else if (PlayState.SONG.song.toLowerCase() == '2hot') 
		{ 
			levelInfo.text += PlayState.SONG.song + daComposer + ' ft. IvanAlmighty';
		}
		else
		{
			levelInfo.text += PlayState.SONG.song + daComposer;
		}
