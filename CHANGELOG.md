...
## [0.3.0] - September to  November 2023
### Added
- Final Update till FULL ASS GAME
- Darnell vs Pico WoAHH! 3 new Songs by KAwaiSprite (Darnell, Lit-up, 2HOT)
- ??? VS BF AND GF 
- eddsworld prob for week 9
- WEEK 7.5 - WEEK 10
- Recharted Some songs like dadbattle and guns
- New Difficulty (ERECT!!!!)  24 NEW REMIXED FUNKIN SONGS
- Song Pitcher In CHART MENu
- NEW COMBO SYSTEM (The One NInjaMuffin99 Showed On Stream)
- NAUGHTYNESS OPTION NOW WORKS
- Language TRANSLATIONS
- ANIMATED ICONS
- SMOOTHER HEALTH BAR 
### Fixed
- Mp4 Cutscenes on Desktop

## [0.2.9] - leaked + Unreleased - March 2022
### Added
-  DARNELL! 3 NEW SONGS BY KAWAISPRITE (DARNELL, LIT-UP, 2hot)
- New Difficulty (ERECT!!!!)  24 NEW REMIXED FUNKIN SONGS
- Song Pitcher In CHART MENu
- NEW COMBO SYSTEM 
